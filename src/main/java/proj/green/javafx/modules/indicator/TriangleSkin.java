 ...
 *
 */
public class TriangleSkin extends BusyIndicatorSkin {

    public TriangleSkin(final BusyIndicator control, final BusyIndicatorBehavior behavior) {
    ...
    public Shape createBlade(final double opacity, final int index) {
        ...
        final Polygon blade = PolygonBuilder.create()
                .points(0.0d, 0.0d,
                        control.getWeight()/2.0, control.getSize()*1.0,
